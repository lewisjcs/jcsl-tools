...
| Cartographer boundary checker | `bash plugins/cartographer/skills/cartograph-report/scripts/check-core-profile-boundary.sh` — boundary enforcement per RC-7. Included in the `check-knowledge-grounding.test.sh` fixture suite. |
