...
| [`gauntlet`](plugins/gauntlet/) | Multi-skill AI review harness. Detects an artifact's type (code diff, plan, doc, skill, directive) and routes it through domain review lanes — typed finder/validator pairs or runtime-driven Class auditors — plus a security pass on everything. | `/gauntlet [<pr-url>\|<path>\|<directory>]` |
