...
```
/gauntlet:run https://github.com/<org>/<repo>/pull/<n>   — a pull request (code diff)
/gauntlet:run                                            — the local branch diff
/gauntlet:run <path-to-file.md>                          — a plan, doc, skill, or agent-instruction file
```
