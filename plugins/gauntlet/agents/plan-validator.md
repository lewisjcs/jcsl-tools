...
4. Read relevant source files referenced by the plan if the finding hinges on what already exists in the codebase (per the Tool-discipline rule in the grounding contract above). Confidence >85 requires evidence beyond the plan text.
