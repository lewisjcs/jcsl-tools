...
if [ "$CTR" -ge 2 ]; then
  MSG="Context load is high and you just hit a '$BOUNDARY' boundary — a clean checkpoint. Invoke the context-economy skill to decide clear vs. compact now; if you clear, use the handoff skill first, then /clear. (nudge #$CTR)"
else
